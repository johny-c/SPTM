...
NAVIGATION_WAD_TRAIN = os.path.join(DATA_PATH, 'Train/D3_battle_navigation.wad_manymaps_train.wad')
NAVIGATION_WAD_TRAIN_EDGE = os.path.join(DATA_PATH, 'Train/D3_battle_navigation_split.wad_manymaps_test.wad')
...
EXPERIMENT_DESCRIPTION_PATH_TEMPLATE = os.path.join(EXPERIMENTS_PATH_TEMPLATE, 'readme.txt')
...
ACTION_MODEL_ITERATION = 18999
EDGE_MODEL_ITERATION = 9999 # 14999
ACTION_MODEL_PATH = os.path.join((MODELS_PATH_TEMPLATE % ACTION_EXPERIMENT_ID), 'model.%.6d.h5' % ACTION_MODEL_ITERATION)
ACTION_MODEL_WEIGHTS_PATH = os.path.join((MODELS_PATH_TEMPLATE % ACTION_EXPERIMENT_ID), 'action_model_weights.h5')
EDGE_MODEL_PATH = os.path.join((MODELS_PATH_TEMPLATE % EDGE_EXPERIMENT_ID), 'model.%.6d.h5' % EDGE_MODEL_ITERATION)
EDGE_MODEL_WEIGHTS_PATH = os.path.join((MODELS_PATH_TEMPLATE % EDGE_EXPERIMENT_ID), 'action_model_weights.h5')
...
LAST_MODEL_CHECKPOINT_PERIOD = 5
...
MAX_YIELD_COUNT_BEFORE_RESTART = int(20 * 100 * 64 / BATCH_SIZE)
...
create_directory(EVALUATION_PATH)
create_directory(SHORTCUTS_OUTPUT_PATH)
